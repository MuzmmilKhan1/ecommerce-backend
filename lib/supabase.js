...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL; // e.g., https://<project-id>.supabase.co
const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY; // Anon public key
